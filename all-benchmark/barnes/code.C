...
int main (int argc, string argv[])
{
   ...
   Global = NULL;
printf("kleeeeeeeeeeeeeeeeeeeeeeee!\n");
   //initparam(defv);
   startrun();
printf("kleeeeeeeeeeeeeeeeeeeeeeee!\n");
   initoutput();
...
void startrun()
{
   ...
   Local[0].nstep = 0;
   pranset(seed);
printf("kleeeeeeeeeeeeeeeeeeeeeeee1!\n");
   testdata();
printf("kleeeeeeeeeeeeeeeeeeeeeeee2!\n");
   ANLinit();
printf("kleeeeeeeeeeeeeeeeeeeeeeee3!\n");
   setbound();
printf("kleeeeeeeeeeeeeeeeeeeeeeee4!\n");
...
printf("kleeeeeeeeeeeeeeeeeeeeeeee5!\n");
      Type(p) = BODY;
printf("kleeeeeeeeeeeeeeeeeeeeeeee5!\n");
      Mass(p) = 1.0 / nbody;
printf("kleeeeeeeeeeeeeeeeeeeeeeee5!\n");
