...
for /l %%b in (1, 1, %RUN_TIMES%) do (
    %current_path%\..\programme\programme.exe < %current_path%\..\programme\input
)
move %current_path%\statistic.log %current_path%\..\statistic\0_load.log
move %current_path%\sequence.log %current_path%\..\statistic\sequence_0_load.log
...
move %current_path%\sequence.log %current_path%\..\statistic\sequence_1_load.log
...
move %current_path%\sequence.log %current_path%\..\statistic\sequence_7_load.log
...
move %current_path%\sequence.log %current_path%\..\statistic\sequence_8_load.log
